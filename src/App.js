  ...
  const onAddToCart = async  (obj) => {
    try {
      ...
      if (findItem) {
        ...
        await axios.delete(`https://6290ab25665ea71fe13810d5.mockapi.io/cart/${findItem.id}`)
      } else {
        setCartItems((prev) => [...prev, obj])
        const { data } = await axios.post('https://6290ab25665ea71fe13810d5.mockapi.io/cart', obj)
      ...
      alert('Ошибка при добавления в корзину')
      console.error(error)
    }
  }
